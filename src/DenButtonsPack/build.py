...
class Builder(ModBuilder):
    ...
    def build(self, src: Path, dst: Path) -> None:
            ...
            rangers.modbuilder.make_info(
                {
                    ...
                    'SmallDescriptionEng': 'English small description',
                    'FullDescriptionEng': f'English full description.\n'
        ...
        for img_file in tqdm(list((src / 'buttons').glob('**/*.png'))):
            ...
            cachedata['Bm']['Buttons']['18'][rel_gi_file.parts[-2].capitalize()][rel_gi_file.parts[-3].capitalize()][rel_gi_file.stem] = str(rel_gi_file)
